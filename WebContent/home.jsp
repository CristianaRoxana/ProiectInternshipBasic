		...
		<div class="row">
		   <div class="col-sm-4" ><p>Transport:</p>
			   <select name="transport">
				  <option value="1" ${'Avion' eq param.city ? 'selected' : ''}>Avion</option>
				  <option value="2" selected>Autocar</option>
				  <option value="3" ${'Fara transport' eq param.city ? 'selected' : ''}>Fara transport</option>
				</select>
			</div>
		     <div class="col-sm-4" ><p>Masa:</p>
			   <select name="masa">
				  <option value="1" selected>oricare</option>
				  <option value="2"  ${'Mic dejun' eq param.city ? 'selected' : ''}>Mic dejun</option>
				  <option value="3"${'Demipensiune' eq param.city ? 'selected' : ''}>Demipensiune</option>
				  <option value="4"${'All inlcusive' eq param.city ? 'selected' : ''}>All inlcusive</option>
				</select>
			</div>
		     <div class="col-sm-4"><p>Stele:</p>
				<select name="stele">
			    <option value="1" selected>*</option>
			    <option value="2" ${'**' eq param.city ? 'selected' : ''}>**</option>
			    <option value="3" ${'***' eq param.city ? 'selected' : ''}>***</option>
			    <option value="4" ${'****' eq param.city ? 'selected' : ''}>****</option>
			     <option value="5" ${'*****' eq param.city ? 'selected' : ''}>*****</option>
				</select>
			</div>
			</div>
